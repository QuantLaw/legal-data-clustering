...
US_SNAPSHOT_MAPPING_EDGELIST_PATH = (
    f"{US_DATA_PATH}/5_snapshot_mapping_edgelist"
)
...
DE_SNAPSHOT_MAPPING_EDGELIST_PATH = (
    f"{DE_DATA_PATH}/5_snapshot_mapping_edgelist"
)
...
US_REG_CD_CLUSTER_EVOLUTION_PATH = (
    f"{US_REG_DATA_PATH}/13_cluster_evolution_graph"
)
...
DE_REG_CD_CLUSTER_EVOLUTION_PATH = (
    f"{DE_REG_DATA_PATH}/13_cluster_evolution_graph"
)
